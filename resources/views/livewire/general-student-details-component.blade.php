<x-app-layout>
  <br />
  {!! QrCode::size(160)->generate('Hello Students') !!}
  ...
  <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-0">
      <div class="flex flex-row  items-end gap-2 justify-between p-2 bg-slate-50">
        <img class="w-32 h-36 mb-3 rounded-lg shadow-lg" src="/docs/images/people/oip.jpeg" alt="Bonnie image" />
        <img class="w-24 h-24 mb-3 shadow-lg " src="{{ url('./img/V-A-10-SAHINA KHATUN.svg') }}" alt="Bonnie image" />
      </div>


      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{$studentcr->studentdb->name}}</h5>
      <span class="text-sm text-gray-500 dark:text-gray-400">{{$studentcr->myclass->name}}
        {{$studentcr->section->name}}: {{$studentcr->roll_no}}</span>
